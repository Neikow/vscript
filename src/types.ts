...
export const OPERATORS: {
  [key in OPERATOR]: { asso: Asso; left: boolean; right: boolean };
} = {
  assign: { asso: Asso.RTL, left: true, right: true },
  add_assign: { asso: Asso.RTL, left: true, right: true },
  sub_assign: { asso: Asso.RTL, left: true, right: true },
  pow_assign: { asso: Asso.RTL, left: true, right: true },
  mul_assign: { asso: Asso.RTL, left: true, right: true },
  div_assign: { asso: Asso.RTL, left: true, right: true },
  mod_assign: { asso: Asso.RTL, left: true, right: true },
  wdiv_assign: { asso: Asso.RTL, left: true, right: true },
  add: { asso: Asso.LTR, left: true, right: true },
  uadd: { asso: Asso.RTL, left: false, right: true },
  sub: { asso: Asso.LTR, left: true, right: true },
  usub: { asso: Asso.RTL, left: false, right: true },
  mul: { asso: Asso.LTR, left: true, right: true },
  mod: { asso: Asso.LTR, left: true, right: true },
  ptr: { asso: Asso.RTL, left: false, right: true },
  div: { asso: Asso.LTR, left: true, right: true },
  wdiv: { asso: Asso.LTR, left: true, right: true },
  pow: { asso: Asso.RTL, left: true, right: true },
  geq: { asso: Asso.LTR, left: true, right: true },
  leq: { asso: Asso.LTR, left: true, right: true },
  lt: { asso: Asso.LTR, left: true, right: true },
  gt: { asso: Asso.LTR, left: true, right: true },
  eq: { asso: Asso.LTR, left: true, right: true },
  neq: { asso: Asso.LTR, left: true, right: true },
  not: { asso: Asso.RTL, left: false, right: true },
  and: { asso: Asso.LTR, left: true, right: true },
  or: { asso: Asso.LTR, left: true, right: true },
  xor: { asso: Asso.LTR, left: true, right: true },
  access_computed: { asso: Asso.LTR, left: true, right: true },
  access_property: { asso: Asso.LTR, left: true, right: true },
  access_call: { asso: Asso.LTR, left: true, right: true },
  cast: { asso: Asso.LTR, left: true, right: true },
  typeof: { asso: Asso.RTL, left: false, right: true },
  delete: { asso: Asso.RTL, left: false, right: true },
  in: { asso: Asso.LTR, left: true, right: true },
  as: { asso: Asso.LTR, left: true, right: true },
  decr: { asso: Asso.NA, left: true, right: false },
  incr: { asso: Asso.NA, left: true, right: false },
  range: { asso: Asso.LTR, left: true, right: true },
} as const;
